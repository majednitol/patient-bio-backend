...
export declare class StripeService {
    ...
    getAllCardholders(): Promise<Stripe.Response<Stripe.ApiList<Stripe.Issuing.Cardholder>>>;
    searchCardholder(params: any): Promise<Stripe.Response<Stripe.Issuing.Cardholder>>;
    createCardholder(params: Stripe.Issuing.CardholderCreateParams): Promise<Stripe.Response<Stripe.Issuing.Cardholder>>;
    updateCardholder(id: string, params: any): Promise<Stripe.Response<Stripe.Issuing.Cardholder>>;
    getAllCards(): Promise<Stripe.Response<Stripe.ApiList<Stripe.Issuing.Card>>>;
    searchCard(params: any): Promise<Stripe.Response<Stripe.Issuing.Card>>;
    createCard(params: any): Promise<Stripe.Response<Stripe.Issuing.Card>>;
    updateCard(id: string, params: any): Promise<Stripe.Response<Stripe.Issuing.Card>>;
    getAllTransactions(): Promise<Stripe.Response<Stripe.ApiList<Stripe.Issuing.Transaction>>>;
    searchTransaction(params: any): Promise<Stripe.Response<Stripe.Issuing.Transaction>>;
    getAllAuthorisations(): Promise<Stripe.Response<Stripe.ApiList<Stripe.Issuing.Authorization>>>;
    searchAuthorisation(params: any): Promise<Stripe.Response<Stripe.Issuing.Authorization>>;
    processAuthorisation(id: string, approve: boolean, params: any): Promise<Stripe.Response<Stripe.Issuing.Authorization>>;
    getAllDisputes(): Promise<Stripe.Response<Stripe.ApiList<Stripe.Issuing.Dispute>>>;
    searchDispute(params: any): Promise<Stripe.Response<Stripe.Issuing.Dispute>>;
    createDispute(params: any): Promise<Stripe.Response<Stripe.Issuing.Dispute>>;
    submitDispute(id: string, params: any): Promise<Stripe.Response<Stripe.Issuing.Dispute>>;
    constructEvent(requestBody: any, signature: any): Promise<Stripe.Event>;
}
