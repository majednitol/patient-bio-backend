...
exports.CardModule = CardModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: card_1.Card.name, schema: card_1.CardSchema }]),
        ],
        controllers: [card_controller_1.CardController],
        providers: [card_service_1.CardService, stripe_service_1.StripeService],
    })
], CardModule);
