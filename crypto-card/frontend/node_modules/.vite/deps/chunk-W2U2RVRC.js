  ...
  "node_modules/@stablelib/sha256/lib/sha256.js"(exports) {
    ...
    function hashBlocks(w2, v, p2, pos, len) {
      while (len >= 64) {
        ...
        for (var i = 0; i < 16; i++) {
          var j2 = pos + i * 4;
          w2[i] = binary_1.readUint32BE(p2, j2);
        }
        for (var i = 16; i < 64; i++) {
          var u = w2[i - 2];
...
function Mn(e) {
  const n = (0, import_sha256.hash)(fromString2(e, F));
  return toString2(n, p);
}
function Pe(e) {
...
function Kn(e) {
  ...
  const t = typeof e.senderPublicKey < "u" ? fromString2(e.senderPublicKey, p) : void 0, r = typeof e.iv < "u" ? fromString2(e.iv, p) : (0, import_random.randomBytes)(Z), o = new import_chacha20poly1305.ChaCha20Poly1305(fromString2(e.symKey, p)).seal(r, fromString2(e.message, F));
...
function Ln(e) {
  ...
  return toString2(o, F);
}
function Te(e) {
  if ($(e.type) === _) {
    if (typeof e.senderPublicKey > "u")
      throw new Error("Missing sender public key for type 1 envelope");
    return toString2(concat([e.type, e.senderPublicKey, e.iv, e.sealed]), x);
  }
  return toString2(concat([e.type, e.iv, e.sealed]), x);
}
function ee(e) {
  const n = fromString2(e, x), t = n.slice($n, Ie), r = Ie;
  if ($(t) === _) {
...
function xn(e, n) {
  const t = ee(e);
  return Re({ type: $(t.type), senderPublicKey: typeof t.senderPublicKey < "u" ? toString2(t.senderPublicKey, p) : void 0, receiverPublicKey: n == null ? void 0 : n.receiverPublicKey });
}
function Re(e) {
...
tslib/tslib.es6.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-W2U2RVRC.js.map
