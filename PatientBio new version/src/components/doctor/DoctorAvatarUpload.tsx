...
export const DoctorAvatarUpload = ({
  userId,
  currentAvatarUrl,
  fullName,
  onUploadComplete,
  ...
  const handleFileSelect = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const fileName = `${userId}/doctor-avatar-${Date.now()}.${fileExt}`;
  ...
  return (
    <div className="flex flex-col items-center gap-3">
      <div className="relative group">
        <Avatar
          className={cn(
            "h-24 w-24 cursor-pointer ring-2 ring-offset-2 ring-primary/20 transition-all",
